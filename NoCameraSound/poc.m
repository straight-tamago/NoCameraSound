...
void startr_0(void) {
    g_arg_target_file_path = "/System/Library/Audio/UISounds/photoShutter.caf";
    g_arg_overwrite_file_path = "/etc/hosts";
    unaligned_copy_switch_race();
}
void startr_1(void) {
    g_arg_target_file_path = "/System/Library/Audio/UISounds/begin_record.caf";
    g_arg_overwrite_file_path = "/etc/hosts";
    unaligned_copy_switch_race();
}
void startr_2(void) {
    g_arg_target_file_path = "/System/Library/Audio/UISounds/end_record.caf";
    g_arg_overwrite_file_path = "/etc/hosts";
    unaligned_copy_switch_race();
}
